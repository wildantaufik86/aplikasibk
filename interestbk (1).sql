...
--
-- Host: localhost:3306
-- Generation Time: May 17, 2022 at 04:37 PM
...
INSERT INTO `tb_konsultasi` (`id_konsultasi`, `nis`, `nama_siswa`, `tanggal`, `judul_keluhan`, `keluhan`, `id_siswa`) VALUES
(2004, '131214', 'GOLD D. ROGER', '2022-05-01', '1', '1                ', 17),
...
--
ALTER TABLE `tb_konsultasi`
  MODIFY `id_konsultasi` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2006;
...
--
ALTER TABLE `tb_pengguna`
  MODIFY `id_pengguna` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
