                     ...
                     <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><i><a href="?page=keluhansiswa&id=<?php echo $row3['id_siswa'];?>">keluhan</a> / <a onclick="return confirm('Yakin akan hapus data ini ?')" href="siswa_hapus.php?id=<?php echo $row3['id_siswa'];?>">Hapus</a></i></td>
                            </tr>
                            <?php
                                }
                            ?>
